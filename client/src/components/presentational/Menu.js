...
const Menu = ({ user }) => {
  return(
    <ul id="slide-out" class="side-nav fixed">
      ...
      <li className="center-align">Hi! {(user) ? user.firstName + " " + user.lastName : '' }</li>
      <li>
        <Link to="/main/edit_profile" className="waves-effect">
      ...
      <li>
        ...
        <Link to="/main/view" className="waves-effect">
